    ...
    <div class="bg-gray-900">  
      <main class="relative isolate">
        ...
        <div class="absolute inset-x-0 top-4 -z-10 flex transform-gpu justify-center overflow-hidden blur-3xl">
          <svg viewBox="0 0 1108 632" class="w-[69.25rem] flex-none" aria-hidden="true">
            <path fill="url(#eee5076e-98f8-4901-b4c5-181a87854225)" fill-opacity=".25" d="M235.233 402.61 57.541 321.574.83 631.051 235.233 402.61l320.018 145.945c-65.036-115.26-134.286-322.756 109.01-230.654C968.382 433.027 1031 651.248 1092.23 459.361c48.98-153.51-34.51-321.107-82.37-385.717l-198.908 250.58L648.261.089 235.233 402.61Z" />
            <defs>
              <linearGradient id="eee5076e-98f8-4901-b4c5-181a87854225" x1="1220.59" x2="-85.053" y1="432.767" y2="638.715" gradientUnits="userSpaceOnUse">
          ...
          <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
            <div v-for="value in values" :key="value.name" class="relative pl-9">
              <dt class="inline font-semibold text-white">
                <component :is="value.icon" class="absolute top-1 left-1 h-5 w-5 text-indigo-500" aria-hidden="true" />
                {{ value.name }}
              </dt>
              {{ ' ' }}
        ...
        <div class="relative isolate -z-10 mt-32 sm:mt-40">
          ...
          <div class="absolute inset-x-0 -top-16 -z-10 flex transform-gpu justify-center overflow-hidden blur-3xl">
            <svg viewBox="0 0 1318 752" class="w-[82.375rem] flex-none" aria-hidden="true">
              <path fill="url(#ee394704-5802-4a27-9451-3d29bf7415a3)" fill-opacity=".25" d="m279.655 479.549-211.511-96.46L.638 751.469l279.017-271.92 380.928 173.723c-77.415-137.198-159.845-384.186 129.758-274.555C1152.34 515.756 1226.88 775.51 1299.76 547.101c58.31-182.726-41.07-382.222-98.04-459.13L964.951 386.243 771.295.416 279.655 479.55Z" />
              <defs>
                <linearGradient id="ee394704-5802-4a27-9451-3d29bf7415a3" x1="1452.56" x2="-101.59" y1="515.446" y2="760.592" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#4F46E5" />
                  <stop offset="1" stop-color="#80CAFF" />
                </linearGradient>
              </defs>
