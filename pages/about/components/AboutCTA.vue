<template>
    <div class="mx-auto max-w-7xl px-6 py-8 sm:py-8 lg:flex lg:items-center lg:justify-between lg:px-8 mt-6 lg:mt-32">
      ...
      <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">{{ $t('home.cta_text') }}</h2>
    </div>
</template>
