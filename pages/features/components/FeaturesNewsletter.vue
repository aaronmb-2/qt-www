      ...
      >
        <div class="max-w-xl lg:max-w-lg">
          <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">
            {{ $t("home.newsletter_leading_text") }}
          </h2>
          <p class="mt-4 text-lg leading-8">
            {{ $t("home.newsletter_helper_text") }}
          </p>
        ...
        <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
          <div class="flex flex-col items-start">
            ...
            <dt class="mt-4 font-semibold">
              {{ $t("home.newsletter_leading_text_weekly") }}
            </dt>
            <dd class="mt-2 leading-7">
              {{ $t("home.newsletter_helper_text_weekly") }}
            </dd>
          </div>
          <div class="flex flex-col items-start">
            <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
            ...
            <dt class="mt-4 font-semibold">
              {{ $t("home.newsletter_leading_text_spam") }}
            </dt>
            <dd class="mt-2 leading-7">
              {{ $t("home.newsletter_helper_text_spam") }}
            </dd>
          </div>
        </dl>
      </div>
