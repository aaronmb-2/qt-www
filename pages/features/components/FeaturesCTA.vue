<template>
  <div class="bg-slate-200 dark:bg-slate-700">
    ...
    <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">{{ $t("features.cto.title_first") }}<br /><div class="dark:text-pink-200 text-pink-400">{{ $t("features.cto.title_second") }}</div></h2>
...
</template>{{ $t("features.hero.title") }}
