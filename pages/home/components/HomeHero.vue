  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-16">
        <div class="text-center">
          <h1 class="text-2xl font-bold tracking-tight sm:text-6xl">{{ $t('home.hero_leading_text') }}</h1>
          <p class="mt-6 text-l sm:text-lgleading-8 text-slate-500">{{  $t('home.hero_helper_text') }}</p>
