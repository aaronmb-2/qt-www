    ...
    >
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
        <h1 class="mt-10 text-4xl font-bold tracking-tight sm:text-6xl">
          {{ $t("home.image_leading_text") }}
        </h1>
        <p class="mt-6 text-lg leading-8 text-slate-500">
          {{ $t("home.image_helper_text") }}
        </p>
      </div>
      <div
      ...
      >
        <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
          <img
            src="@/assets/images/trading-app.png"
            alt="App screenshot"
            width="2432"
            height="960"
            class="w-[76rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 w-auto h-49"
          />
        </div>
      </div>
    </div>
