  ...
  <div>
    <form class="space-y-4" @submit.prevent="onSubmit">
        ...
        <BaseButton
            ...
            class="font-bold"
        >
          <BaseSpinnerSmall :submit-in-progress="submitInProgress" spinner-text="register.register" button-text="register.register"/>
        </BaseButton>
    </form>
  </div>
</template>
...
const schema = object().shape({
  email: string().required(() => t("global.messages.field_email_required")).email(() => t("global.messages.field_email_invalid")),
  first_name: string().required(() => t("global.messages.field_first_name_required")),
  last_name: string().required(() => t("global.messages.field_last_name_required")),
  password: string().required(() => t("global.messages.field_password_required")).min(10, () => t("global.messages.field_password_too_short")),
  terms_of_service: boolean().required(() => t("global.messages.field_terms_of_service")),
});
